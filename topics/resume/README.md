...
1. [Descarga nuestra plantilla](https://github.com/bright-coders/commons/blob/master/topics/resume/template/resume-bc.docx) y completa la información que se solicita y en la forma que se explica en la siguientes secciones. 
2. Una vez que termines, envíalo utilizando Slack

### Nombre
- Registra tu nombre completo

### Programa
Utiliza el que corresponda:
 - Ruby on Rails Web Developer
 - React Native Mobile Developer

### Datos de contacto
 - Registra tus datos de contacto: teléfono, correo y usuario de github

### About Me
Escribe una breve presentación que te describa, por ejemplo:
...
### Work Experience
- Proyectos o trabajos en los queue has participado. Pueden ser proyectos escolares.

### Education 
- Estudios realizados principalmente formales (ingeniería) aunque también pueden ser informales
